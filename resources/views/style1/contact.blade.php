            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="contact-info-container sm-margin-top-27px xs-margin-bottom-60px xs-margin-top-60px">
                        <h4 class="box-title">Contact With Us</h4>
                        ...
                        <ul class="addr-info">
                            <li>
                                <div class="if-item">
                                    ...
                                    <p class="dsc">{{strip_tags(htmlspecialchars_decode($contact->address))}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="if-item">
                                    <b class="tie">Phone:</b>
                                    <p class="dsc">{{$contact->phone}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="if-item">
                                    <b class="tie">Email:</b>
                                    <p class="dsc">{{$contact->email}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="if-item">
                                    <b class="tie">Store Open:</b>
                                    <p class="dsc">{{$contact->store_open}}</p>
                                </div>
                            </li>
                        </ul>
                        <div class="biolife-social inline">
                            <ul class="socials">
                                @foreach ($socials as $social)
                                    <li>
                                        <a href="{{$social->link}}" title="" class="socail-btn"><i class="{{$social->icon_class}}" aria-hidden="true"></i></a>
                                    </li>
                                @endforeach
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="contact-form-container sm-margin-top-112px">
                        <form action="{{route('contactMessage')}}" method="post" name="frm-contact" >
                            @csrf
                            <p class="form-row">
                                <input type="text" name="name" placeholder="Your Name" class="txt-input">
                            </p>
                            <p class="form-row">
                                <input type="email" name="email" placeholder="Email Address" class="txt-input">
                            </p>
                            <p class="form-row">
                                <input type="tel" name="phone" placeholder="Phone Number" class="txt-input">
                            </p>
                            <p class="form-row">
