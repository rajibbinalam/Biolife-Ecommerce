        ...
        <table id="data_table" class="table card-body" style="margin-top: 34px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $pickup->name}}</td>
              <td>
                <a href="{{url('/admin/pickup/delete/'.$pickup->id)}}" class="delete"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  action="{{route('admin.pickupLocationCreate')}}" id="form" method="POST">
          @csrf
          <div class="form-group">
            <label for="">@lang('Location Name')</label>
            <input type="text" class="form-control" name="name" required placeholder="Location Name">
