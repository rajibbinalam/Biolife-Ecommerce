      ...
      <a href="{{route('admin.blogpostcreate')}}" class="btn btn-primary" style="margin: 0 0 18px 15px;">Back</a>
        <form action="{{route('admin.blogpostinsert')}}" method="post" enctype="multipart/form-data">
          @csrf
            ...
            <div class="form-group col-md-6">
              <label for="exampleFormControlFile1">@lang('Category')</label>
            ...
            <div class="form-group col-md-12">
                <label for="inputEmail">@lang('Details')</label>
            ...
            <div class="form-group col-md-6">
              <label for="inputEmail">@lang('Tags')   <small class="text-muted"> ( use (,) for Separate )</small></label>
            ...
            <div class="form-group col-md-6">
              <label>Author</label>
              <input type="text" class="form-control" name="auth_name" value="{{auth()->guard('admin')->user()->name}}" id="exampleFormControlFile1" readonly>
            </div>
            <div class="form-group col-md-6">
              <label for="exampleFormControlFile1">@lang('Feature Image')</label>
            ...
            <div class="form-group col-md-12">
              <button type="submit" class="btn btn-primary" style="float: right;">@lang('Submit')</button>
            </div>
