        ...
        <table class="table card-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $banner->price}}</td>
              <td><img src="{{ $banner->image}}" height="45px" width="100px" alt="Logo image"></td>
              <td>
                <a href="{{url('/admin/top-banner/edit/'.$banner->id)}}" style="color: white; background-color: #00a65a; padding: 8px; border-radius: 24px;"><i class="fa fa-edit"></i></a>
                <a href="{{url('/admin/top-banner/delete/'.$banner->id)}}" style="color: white; background-color: #ff0000; padding: 8px; border-radius: 24px;" OnClick='return (confirm("Are you sure Delete Logo"));'><i class="fa fa-trash"></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('admin.topbannerinsert')}}" method="post" enctype="multipart/form-data">
          @csrf
